Public Class FormLapSeluruh
    Sub cb_tahun()
        Dim q As String = "SELECT DISTINCT Year(tgl_beli) AS tahun from tbl_kendaraan"
    ...
    End Sub
    Sub cb_bulan()
        Dim q As String = "SELECT DISTINCT Month(tgl_beli) AS no_bulan " _
                        & "FROM tbl_kendaraan " _
                        & "WHERE year(tgl_beli) = '" & cbtahun1.Text & "'"
    ...
    Private Sub btncetak_Click(sender As Object, e As EventArgs) Handles btncetak.Click
        If rbperiode.Checked Then
            FormViewCR.CetakSeluruhPeriode()
            FormViewCR.ShowDialog()
        ElseIf rbbulan.Checked Then
            FormViewCR.CetakSeluruhBulanan()
            FormViewCR.ShowDialog()
        ElseIf rbtahun.Checked Then
            FormViewCR.CetakSeluruhTahunan()
            FormViewCR.ShowDialog()
        End If
    End Sub
