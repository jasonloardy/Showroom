...
Public Class CRKendaraanCash
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Showroom.CRKendaraanCash.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedCRKendaraanCash
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As CRKendaraanCash = New CRKendaraanCash()
        rpt.Site = Me.Site
        Return rpt
    End Function
