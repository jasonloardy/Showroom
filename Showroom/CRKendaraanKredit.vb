...
Public Class CRKendaraanKredit
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Showroom.CRKendaraanKredit.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedCRKendaraanKredit
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As CRKendaraanKredit = New CRKendaraanKredit()
        rpt.Site = Me.Site
        Return rpt
    End Function
